...
class Erp_Sync_Tool_Settings {
    ...
    public function erp_sync_tool_options_validate( $input ) 
    {
        ...
        $newinput['root_url'] = trim( $input['root_url'] );
    ...
    public function add_api_settings( $options )
    {
        ...
        add_settings_field( 'erp_sync_tool_setting_root_url', 'Root URL', array( $this, 'api_root_url_field'), 'erp_sync_tool', 'api_settings', $options );
    ...
    public function refresh_service_settings( $options )
    {
        ...
        $result = wp_remote_get( 
            $root .'services?client=' . $options['client_name'], 
            array(
                'headers' => array ( 
                    'Accept' => 'Application/json',
    ...
    public function api_root_url_field( $options ) 
    {
        echo "<input id='erp_sync_tool_options_root_url' name='erp_sync_tool_options[root_url]' type='text' value='" . esc_attr( $options['root_url'] ) . "' />";
    }
